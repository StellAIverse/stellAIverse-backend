...
import { AgentEvent, AgentEventType } from '../src/audit/entities/agent-event.entity';
import { OracleSubmission, OracleSubmissionStatus } from '../src/audit/entities/oracle-submission.entity';
import { ComputeResult, ComputeResultStatus } from '../src/audit/entities/compute-result.entity';
...
async function seedAuditData(dataSource: DataSource) {
  ...
  const sampleAgentEvents = [
    {
      ...
      eventData: { name: 'Sample Agent', description: 'A sample agent for testing' },
    ...
    },
    {
      ...
      eventData: { inputs: { param1: 'value1' }, outputs: { result: 'success' } },
  ...
  const sampleOracleSubmissions = [
    ...
    },
    {
      ...
      signature: '0x1234567890abcdef1234567890abcdef1234567890abcdef1234567890abcdef1234567890abcdef1234567890abcdef1234567890abcdef1234567890',
      status: OracleSubmissionStatus.SUBMITTED,
      userId: users[1].id,
      submittedAt: new Date(Date.now() - 1800000), // 30 minutes ago
      transactionHash: '0x456def1234567890abcdef1234567890abcdef1234567890abcdef1234567890',
      retryAttempts: 1,
    ...
    },
    {
      ...
      signature: '0x0987654321fedcba0987654321fedcba0987654321fedcba0987654321fedcba0987654321fedcba0987654321fedcba0987654321fedcba0987654321fedcba',
  ...
  console.log(`✅ Inserted ${sampleOracleSubmissions.length} oracle submissions`);
  ...
  const sampleComputeResults = [
    ...
    },
    {
      jobId: 'job-789',
      resultData: {},
      resultHash: '0x3333333333333333333333333333333333333333333333333333333333333333',
