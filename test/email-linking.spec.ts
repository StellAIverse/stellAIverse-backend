...
describe("EmailLinkingService", () => {
  ...
  describe("initiateEmailLinking", () => {
    it("should initiate email linking for new user", async () => {
      ...
      jest
        .spyOn(emailVerificationRepository, "delete")
        .mockResolvedValue(undefined);
      jest
        .spyOn(emailVerificationRepository, "create")
        .mockReturnValue({} as EmailVerification);
      jest
        .spyOn(emailVerificationRepository, "save")
        .mockResolvedValue({} as EmailVerification);
  ...
  describe("unlinkEmail", () => {
    it("should unlink email from wallet", async () => {
      ...
      const result = await service.unlinkEmail(
        "0x1234567890123456789012345678901234567890",
      );
